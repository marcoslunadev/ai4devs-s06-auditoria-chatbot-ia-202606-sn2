...
- **Bases legales por finalidad:**
  - **Ejecución del contrato (Art. 6.1.b del GDPR):** 
    - Para la consulta de saldos, movimientos y descarga de extractos, el tratamiento es indispensable para ejecutar el contrato de servicios bancarios solicitado por el cliente.
    - Para la función de **bloqueo preventivo de tarjetas**, esta constituye una facultad contractual (y no una obligación legal de bloqueo directo) habilitada por el **Artículo 68(2) de la Directiva (UE) 2015/2366 (PSD2)** (y su correspondiente transposición en el Art. 38.2 del Real Decreto-ley 19/2018), según la cual el banco se reserva el derecho a bloquear el instrumento de pago por motivos objetivamente justificados relacionados con la seguridad o sospecha de uso no autorizado o fraudulento, de acuerdo con lo previsto en el contrato marco.
  - **Obligación legal (Art. 6.1.c del GDPR):** Para dar cumplimiento a las obligaciones impuestas tras el bloqueo preventivo, consistentes en informar de manera obligatoria al cliente sobre el bloqueo y sus motivos (conforme al **Artículo 68(3) de la PSD2** / Art. 38.3 del RDL 19/2018) y proceder a desbloquear o sustituir el instrumento tan pronto como dejen de existir los motivos que justificaron la medida (conforme al **Artículo 68(4) de la PSD2** / Art. 38.4 del RDL 19/2018).
  - **Interés legítimo (Art. 6.1.f del GDPR):** Para aquellas situaciones de seguridad que excedan la facultad contractual estricta (como la mitigación proactiva y el análisis de patrones complejos de fraude cruzado entre cuentas o la detección preventiva de robos de identidad de forma externa), el tratamiento se justifica en el interés legítimo del banco para mitigar fraudes y riesgos financieros. Se ha realizado un análisis de ponderación determinando que el interés superior de proteger los fondos del cliente y mantener la seguridad del sistema prevalece sobre los derechos del interesado, quien posee la expectativa razonable de que su banco actúe con celeridad ante sospechas de brecha.
